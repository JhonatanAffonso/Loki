                                        ...
                                        <div class="au-card-inner">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <asp:DropDownList ID="dpGeneroFilme" runat="server" class="form-control" required="true">
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="col-sm-7">
                                        ...
                                        <div class="au-card-inner">
                                            <div class="table-responsive">
                                                <asp:GridView ID="gvListarFilmesRecentes" runat="server" AutoGenerateColumns="False" class="table table-sm contagemDois">
                                                    <Columns>
                                                       <asp:BoundField DataField="Titulo" HeaderText="Filmes Recentes" ShowHeader="False">
