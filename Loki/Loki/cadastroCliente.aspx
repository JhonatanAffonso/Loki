...
<body>
    ...
    <div class="container-fluid">
        <%-- Menu Superior--%>
        <div class="row">
            <div class="col-sm-12 menuSuperiorCadastro">
                <img src="images/icon/logoLoki.png" class="img-fluid imgmenuSuperiorCadastro" />
                <div class="text-right">
                    <a href="index.aspx">Entrar</a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="text-center">
                    ...
                    <h6>Faltou pouco para você se tornar um Lockier =)</h6>
                    <br />
                    <br />
                </div>
            </div>
        ...
        <div class="col-sm-8 ml-auto mr-auto">
            <form id="formDadosCliente" runat="server">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="text-center">
                            <asp:Button ID="btnCadastrar" runat="server" Text="Cadastrar" OnClick="btnCadastrar_Click" CssClass="btn btn-success btn-lg" /> <br /><br />
    ...
    <br />
    <!-- Footer -->
    <footer class="page-footer font-small teal pt-4 footerPersol">
        ...
        <div class="container-fluid text-center text-md-left">
            <div class="row">
                <div class="col-md-6 mt-md-0 mt-3">
                    ...
                    <p>Dúvidas?</p>
                    <p>Entre em contato conosco pelo e-mail: adm@loki.com.br</p>
                </div>
